...
def find_users_and_rating_for_movie(movie_id, connection_params):
...
def ratings_from_common_movies(user_j, user_i, connection_params):
...
def insert_weights(user_i, user_j, weight, connection_params):
    with connect(**connection_params) as conn:
            with conn.cursor() as cur:
